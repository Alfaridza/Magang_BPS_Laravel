...
@section('content')
    <div class="bg-white p-8 rounded-xl shadow-md">
        ...
        <p class="text-gray-600">Silahkan lengkapi dan isi data untuk pengajuan magang di halaman daftar magang atau dapat diakses melalui link ini <a href="{{ url('peserta/daftar_magang') }}" class="text-blue-500 hover:underline">Daftar Magang</a></p> 
        <br>
